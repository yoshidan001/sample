...
/**
 * 時代はコロンブスが生きていた15世紀までさかのぼります。 多くの冒険家たちが新大陸発見に躍起になって海へ冒険にでていました。
 * あなたもその冒険家たちの仲間です。
 * 
 ...
 * 
 * エーゲ海は島が密集しており、特に島と島が隣り合っているところは浅瀬なので、 船が座礁しないように回避して通らなければなりません。
 * 
 ...
 * ○○○○○○ ○●●○○○ ○●○○○○ ○○○○●○ ○○○●○○ ○○○○○○
 * 
 * これは21万4千平方キロメートルあるエーゲ海の島データの一部分です。 エーゲ海を100平方キロメートル単位に区切ってデータを持っています。
 * 
 * 黒丸は島があることを意味します。 白丸は島がないことを意味します。
 * 
 ...
 * 
 * ■問題 「島の固まり」をカウントするクラスを完成させてください。 計算結果は、コンソールに出力するようにしてください。
 * 
 ...
 * 言語はJavaを使用してください。
 * 
 * ■資料 AegeanSea.zip: zipファイルを解答してお使いください。 以下の4つファイルが入っています。
 * 
 * answer.txt 解答用サンプルファイルです。
 * 
 * AegeanSea1.csv エーゲ海の島データです。
 * 
 * AegeanSea2.csv エーゲ海の島データです。
 * 
 * AegeanSea3.csv エーゲ海の島データです。
 * 
 * ■解答方法 解答用サンプルファイルに書かれていることにしたがい、解答ファイルを作成し、完成したらファイルアップロードにて提出してください。
 */
public class Q797{
